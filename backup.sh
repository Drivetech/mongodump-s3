...
# Run backup
mongodump --uri=$MONGO_URI --gzip --excludeCollection GLLogs --excludeCollection Resource --excludeCollection UserLogs --excludeCollection UserLogsTOLL --excludeCollection userIdToken -o /backup/dump
# Compress backup
